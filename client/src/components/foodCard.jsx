      ...
      <div className="grow flex justify-between items-center">
        <div class="p-4 flex flex-col justify-between leading-normal">
          <div class="">
            ...
            <p class="text-gray-700 text-base">Expiry info</p>
          </div>
        </div>
        <button className="rounded-full  p-3 mr-4 fill-yellow-700 hover:fill-yellow-950  font-bold">
          <svg x="0px" y="0px" width="32" height="32" viewBox="0 0 128 128">
